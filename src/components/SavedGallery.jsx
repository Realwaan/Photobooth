...
const SavedGallery = ({ isOpen, onClose }) => {
  ...
  const handleDownload = (photostrip) => {
  ...
  // Delete photo strip
  const handleDelete = async (photostrip) => {
    try {
                ...
                {photostrips.map((photostrip, index) => (
                  ...
                  >
                    ...
                    <div 
                      ...
                      onClick={() => setSelectedPhoto(photostrip)}
                    >
                      <img
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <div className="flex gap-2">
                            <motion.button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                handleDownload(photostrip)
                              }}
                              className="flex-1 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/10 p-2 rounded-lg text-white"
                            >
                            ...
                            <motion.button
                              ...
                              className="flex-1 bg-red-500/20 hover:bg-red-500/40 backdrop-blur-sm border border-red-500/20 p-2 rounded-lg text-red-300"
                            >
                    ...
                    <AnimatePresence>
                      {deleteConfirm === photostrip.filename && (
                        <motion.div
                          ...
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                          className="absolute inset-0 bg-slate-900/95 backdrop-blur-sm flex flex-col items-center justify-center p-4"
                        >
                          ...
                          <div className="flex gap-2">
                            ...
                            <motion.button
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                              onClick={() => handleDelete(photostrip)}
